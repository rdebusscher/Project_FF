...
Application created by Spring Initialzr (https://start.spring.io/) with the following options
- Maven - Java - JDK 17 application
- Extensions : Spring reactive Web and GraalVM Native Support
...
```
$ docker run --rm springboot:0.0.1-SNAPSHOT
```
